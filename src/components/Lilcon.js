...
const Lilcon = ({reference}) => {
  ...
  return (
    <figure className='absolute left-0 stroke-dark dark:stroke-light'>
        ...
        <circle cx="75" cy="50" r="20" className=' stroke-orange-600 dark:stroke-primaryDark stroke-1 fill-none'/>
        <motion.circle cx="75" cy="50" r="20" className=' stroke-[5px] fill-light dark:fill-dark'
        style={{
            pathLength : scrollYProgress
        }}
        />
        <circle cx="75" cy="50" r="10" className=' animate-pulse stroke-1 fill-orange-700 dark:fill-primaryDark'/>
